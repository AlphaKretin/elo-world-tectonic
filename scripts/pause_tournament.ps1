# Stops every running tournament watchdog (run_tournament.ps1) and any
...
# "run_tournament.ps1" matches its own process's command line under the
# same filter used to find real watchdogs, causing it to stop itself
# mid-run before it can finish.
